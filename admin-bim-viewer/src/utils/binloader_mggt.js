...
class BinLoader {
    ...
    loadScene() {
        ...
        this.loadSection("MggtEntities", () => this.loadMggtEntities());
    ...
    loadMggtEntities() {
    this.loadArray(() => {
        let entity = this.loadMggtEntity(new Entity());
        this.entities.push(entity);
        this.scene.objectsMap[entity.Id] = entity;
    });
}
    ...
    loadMggtEntity (meshEntity) {
        this.loadMeshEntity(meshEntity);
        let dbTableName = this.loadString();
        let geojson = this.loadString();        
        return meshEntity;
    }
