...
//                        !WSch && _this.action('socketConnect')();
            ...
            WidgetHeader: {
                ...
                content: function(parent){
                    ...
                    createElem(parent, {
                        className: ['k50_widget_header_desc'],
                        didMount: function(e){
                                e.innerHTML = 'Днепропетровск';
                        }
                    });
                },
                create: render,
            ...
            WidgetHeaderClose: {
                ...
                props: {},
                content: function(parent){
                    this.node.innerHTML = '<svg width="30" height="30" viewBox="7 7 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <g transform="translate(-697 -154)"> <use xlink:href="#path0_fillcl" transform="translate(706.343 163.343)" fill="#333333"/> </g> <defs> <path id="path0_fillcl" fill-rule="evenodd" d="M 11.3137 1.41418L 9.89954 0L 5.65686 4.24268L 1.41418 6.10352e-05L 0 1.41425L 4.24268 5.65686L 0 9.89948L 1.41431 11.3137L 5.65686 7.07111L 9.89954 11.3137L 11.3137 9.89954L 7.07104 5.65692L 11.3137 1.41418Z"/> </defs> </svg>';
                },
                action: [{
                    type: 'click',
                    name: function(){
            ...
            ChatSendWrap: {
                ...
                content: function(parent){
                    createElem(parent, {
                        tag: 'img',
                        className: ['k50_chat_send_wrap_avatar'],
                        attribute: {
            ...
            ChatSendInput: {
                tag: 'div',
                className: ['k50_chat_send_input', 'k50_custom-scroll'],
                attribute: {
            ...
            ChatMessageAvatar: {
                ...
                content: function(parent){
                    ...
                    var avatarSrc = this.props.type == 'out' ? 'images/avatar2.png' : 'images/avatar1.png';
            ...
            ChatMessageBody: {
                ...
                parent: null,
                content: function(parent){
                    Component.ChatMessageAvatar.render({parent: parent, props: this.props});
