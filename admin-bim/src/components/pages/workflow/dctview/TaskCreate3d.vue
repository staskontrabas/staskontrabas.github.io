<template>
    <v-card class="m-overhead m-overhead--white d-block pa-4 overflow-auto">
        ...
        <div class="py-4" style="position: relative;">
            <label for="input-477" class="v-label v-label--active theme--light" style="left: 0px; right: auto; position: absolute; max-width: 133%; -webkit-transform: translateY(-18px) scale(0.75); transform: translateY(-18px) scale(0.75); -webkit-transform-origin: top left; transform-origin: top left;">Картинка ошибкиfgre</label>
...
export default {
    name: 'TaskCreate3d',
    props: ['task_form', 'project_id', 'model', 'editMode', 'task', 'screen', 'blob', 'screenshot'],
    data () {
        return {
            activePicker: null,
