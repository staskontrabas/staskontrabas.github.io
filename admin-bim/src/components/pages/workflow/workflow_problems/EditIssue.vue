                    ...
                    <el-tabs v-model="activeName">
                        <el-tab-pane label="Подробности" name="details">
                            <div class="edit-problem-button-panel">
                                <el-button :disabled="has_unsaved_changes" class="remove-margin-right" type="main" @click="changeIssue">
                                    <div class="el-btn-wrap">
                                        <span> Сохранить </span>
                                    </div>
                                </el-button>
                                <el-button class="remove-margin-right" type="default">
                                    <div class="el-btn-wrap delete" @click="deleteProblem">
...
export default {
    ...
    watch: {
        'data'() {
            this.setData()
            console.log('editing prbl',this.issue)
        },
        'problem'() {
            this.setData()
        },
            ...
            this.form_data = Object.assign({}, 
                {
                    ...
                    reason_type: source.reason.types[0] || this.reasons[0].types[0] || null,
                    dscr: source.dscr || '',
