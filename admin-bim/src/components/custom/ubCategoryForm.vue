...
export default{
    ...
    methods: {
        ...
        setNewIssue() {
            ...
            // console.log('new form data', this.form_data)
        },
        setExisting() {
            if (!this.category) {
                return null
            }
            let source = JSON.parse(JSON.stringify(this.category))
